...
public class Utils {
    ...
    //Sample Header style log entry: X-DRun-Model-Id:Model_1
    private static final String LEGION_PROPERTY_PREFIX = "X-DRun-";
    ...
    /**
     * Get DRun script name from the environment variable
     * @return
     */
