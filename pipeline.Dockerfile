...
ADD legion/Pipfile /src/legion/Pipfile
ADD legion/Pipfile.lock /src/legion/Pipfile.lock
RUN cd /src/legion && pipenv install --system --dev

# Install requirements for legion_test package
ADD legion_test/Pipfile /src/legion_test/Pipfile
ADD legion_test/Pipfile.lock /src/legion_test/Pipfile.lock
RUN cd /src/legion_test && pipenv install --system --dev

# Install requirements for legion_airflow package
ADD legion_airflow/Pipfile /src/legion_airflow/Pipfile
ADD legion_airflow/Pipfile.lock /src/legion_airflow/Pipfile.lock
RUN cd /src/legion_airflow && pipenv install --system --dev
