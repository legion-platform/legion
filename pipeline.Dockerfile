...
RUN pip install Sphinx==1.8.0 sphinx_rtd_theme==0.4.1 sphinx-autobuild==0.7.1 recommonmark==0.4.0 pydocstyle==2.3.1 twine==1.11.0 boto==2.49.0 boto3==1.7.28 ansible==2.6.4 awscli
