...
TEMP_DIRECTORY=
TAG=
DOCKER_REGISTRY=nexus.cc.epm.kharlamov.biz:443
...
docker-build-all:  docker-build-pipeline-agent  docker-build-python-toolchain  docker-build-edi  docker-build-edge  docker-build-model-builder  docker-build-operator
...
docker-push-all:  docker-push-pipeline-agent  docker-push-python-toolchain  docker-push-edi  docker-push-edge  docker-push-model-builder  docker-push-operator
