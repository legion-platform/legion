...
from legion.sdk.k8s import utils as k8s_utils, services
from legion.sdk.k8s.definitions import ENCLAVE_NAMESPACE_LABEL, EVENT_ADDED, EVENT_MODIFIED, EVENT_DELETED
from legion.sdk.k8s.definitions import \
    LEGION_COMPONENT_NAME_API, LEGION_COMPONENT_NAME_EDI, \
    LEGION_COMPONENT_NAME_GRAFANA, LEGION_COMPONENT_NAME_GRAPHITE
from legion.sdk.k8s.exceptions import KubernetesOperationIsNotConfirmed
from legion.sdk.k8s.properties import K8SConfigMapStorage, K8SPropertyStorage
from legion.sdk.k8s.services import get_service, ModelService, find_model_services_by, find_model_service, \
    find_model_deployment, ModelServiceEndpoint, Service
from legion.sdk.k8s.watch import ResourceWatch
from legion.sdk.utils import model_properties_storage_name, ensure_function_succeed
...
class Enclave:
    ...
    def _validate_model_properties_storage(self, model_id, model_version, default_values):
        ...
        registered_storages = K8SConfigMapStorage.list(self.namespace)
        storage_name = model_properties_storage_name(model_id, model_version)
        storage = K8SConfigMapStorage(storage_name, self.namespace)
    ...
    def deploy_model(self, image, model_iam_role=None, count=1, livenesstimeout=2, readinesstimeout=2, memory=None,
        ...
        model_properties_default_values_str = labels.get(headers.DOMAIN_MODEL_PROPERTY_VALUES)
        model_properties_default_values = K8SPropertyStorage.parse_data_from_string(
