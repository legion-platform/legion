...
export function showLocalBuildInformationDialog(
  build: model.ILocalBuildInformation
) {
  return showDialog({
...
export function showLocalDeploymentInformationDialog(
  deploymentInformation: model.ILocalDeploymentInformation
) {
  return showDialog({
