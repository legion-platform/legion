...
DOMAIN_CONTAINER_REQUIRED_PROPERTIES = DOMAIN_PREFIX + 'legion.container_required_properties'
DOMAIN_CONTAINER_DEFAULT_PROPERTY_VALUES = DOMAIN_PREFIX + 'legion.container_property_values'
