...
VERSION_FILE = os.path.join(PACKAGE_ROOT_PATH, 'legion/packager/rest', 'version.py')
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'legion-pack-to-rest=legion.packager.rest:work_resource_file'
        ],
    },
