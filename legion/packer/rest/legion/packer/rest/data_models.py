...
class PackagingResourceConnectionBody(pydantic.BaseModel):
    """
    Connection link body
    """
...
class PackagingResourceConnection(pydantic.BaseModel):
    """
    Connection link in targets/sources
    """

    name: str
    connection: str
    body: PackagingResourceConnectionBody
...
class PackagingResource(pydantic.BaseModel):
    ...
    targets: typing.List[PackagingResourceConnection]


class PackagingK8SResource(pydantic.BaseModel):
    """
    Legion Packaging K8S Resource
    """

    spec: PackagingResource
