...
var (
	logC      = logf.Log.WithName("toolchain-integration-storage")
	MaxSize   = 500
	FirstPage = 0
)
...
func (kc *trainingK8sStorage) GetToolchainIntegration(name string) (*training.ToolchainIntegration, error) {
...
func (kc *trainingK8sStorage) GetToolchainIntegrationList(options ...kubernetes.ListOption) ([]training.ToolchainIntegration, error) {
...
func (kc *trainingK8sStorage) DeleteToolchainIntegration(name string) error {
...
func (kc *trainingK8sStorage) UpdateToolchainIntegration(ti *training.ToolchainIntegration) error {
...
func (kc *trainingK8sStorage) CreateToolchainIntegration(ti *training.ToolchainIntegration) error {
