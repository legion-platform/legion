...
var (
	logMT       = logf.Log.WithName("model-training-storage")
	MDMaxSize   = 500
	MDFirstPage = 0
)
...
func (kc *trainingK8sStorage) SaveModelTrainingInfo(id string, info map[string]string) error {
...
func (kc *trainingK8sStorage) GetModelTraining(id string) (*training.ModelTraining, error) {
...
func (kc *trainingK8sStorage) GetModelTrainingList(options ...kubernetes.ListOption) ([]training.ModelTraining, error) {
	...
	labelSelector, err := kubernetes.TransformFilter(listOptions.Filter, mt_storage.TagKey)
	if err != nil {
...
func (kc *trainingK8sStorage) DeleteModelTraining(id string) error {
...
func (kc *trainingK8sStorage) UpdateModelTraining(mt *training.ModelTraining) error {
...
func (kc *trainingK8sStorage) CreateModelTraining(mt *training.ModelTraining) error {
	k8sMd := &v1alpha1.ModelTraining{
		ObjectMeta: metav1.ObjectMeta{
			Name:      mt.Id,
			Namespace: kc.namespace,
...
func (kc *trainingK8sStorage) GetModelTrainingLogs(id string, writer mt_storage.Writer, follow bool) error {
	...
	if err := kc.k8sClient.Get(context.TODO(),
		...
		if mt.Status.State != v1alpha1.ModelTrainingFailed &&
