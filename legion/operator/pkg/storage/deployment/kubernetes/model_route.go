...
var (
	logC      = logf.Log.WithName("modelroute-storage")
	MaxSize   = 500
	FirstPage = 0
)
...
func (kc *deploymentK8sStorage) GetModelRoute(name string) (*deployment.ModelRoute, error) {
...
func (kc *deploymentK8sStorage) GetModelRouteList(options ...kubernetes.ListOption) ([]deployment.ModelRoute, error) {
...
func (kc *deploymentK8sStorage) DeleteModelRoute(name string) error {
...
func (kc *deploymentK8sStorage) UpdateModelRoute(connection *deployment.ModelRoute) error {
...
func (kc *deploymentK8sStorage) CreateModelRoute(connection *deployment.ModelRoute) error {
	conn := &v1alpha1.ModelRoute{
		ObjectMeta: metav1.ObjectMeta{
			Name:      connection.Id,
			Namespace: kc.namespace,
