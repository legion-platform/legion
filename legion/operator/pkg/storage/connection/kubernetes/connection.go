...
var (
	logC      = logf.Log.WithName("connection-storage")
	MaxSize   = 500
	FirstPage = 0
)
...
func NewStorage(namespace string, k8sClient client.Client) conn_storage.Storage {
	return &k8sStorage{
		namespace: namespace,
		k8sClient: k8sClient,
	}
...
func (kc *k8sStorage) GetConnection(name string) (*connection.Connection, error) {
...
func (kc *k8sStorage) GetConnectionList(options ...conn_storage.ListOption) ([]connection.Connection, error) {
	var k8sConnList v1alpha1.ConnectionList

	listOptions := &conn_storage.ListOptions{
	...
	labelSelector, err := kubernetes.TransformFilter(listOptions.Filter, conn_storage.TagKey)
	if err != nil {
...
func (kc *k8sStorage) DeleteConnection(name string) error {
...
func (kc *k8sStorage) UpdateConnection(connection *connection.Connection) error {
...
func (kc *k8sStorage) CreateConnection(connection *connection.Connection) error {
	conn := &v1alpha1.Connection{
		ObjectMeta: metav1.ObjectMeta{
			Name:      connection.Id,
			Namespace: kc.namespace,
