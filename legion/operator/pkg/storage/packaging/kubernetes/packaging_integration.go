...
var (
	logPI     = logf.Log.WithName("packaging-integration-storage")
	MaxSize   = 500
	FirstPage = 0
)

// We should save the arguments structure inside json string in k8s storage
...
func (kc *packagingK8sStorage) GetPackagingIntegration(name string) (*packaging.PackagingIntegration, error) {
...
func (kc *packagingK8sStorage) GetPackagingIntegrationList(options ...kubernetes.ListOption) ([]packaging.PackagingIntegration, error) {
...
func (kc *packagingK8sStorage) DeletePackagingIntegration(name string) error {
...
func (kc *packagingK8sStorage) UpdatePackagingIntegration(pi *packaging.PackagingIntegration) error {
	...
	if updateK8sPi, err := TransformPiToK8s(pi, kc.piNamespace); err != nil {
		return err
	} else {
...
func (kc *packagingK8sStorage) CreatePackagingIntegration(pi *packaging.PackagingIntegration) error {
