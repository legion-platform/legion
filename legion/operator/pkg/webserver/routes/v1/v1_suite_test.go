...
func createModelDeployments(g *gomega.GomegaWithT, c client.Client) []*legionv1alpha1.ModelDeployment {
	...
	g.Expect(c.Create(context.TODO(), md1)).NotTo(gomega.HaveOccurred())
	...
	g.Expect(c.Create(context.TODO(), md2)).NotTo(gomega.HaveOccurred())

	return []*legionv1alpha1.ModelDeployment{md1, md2}
}

func createModelTrainings(g *gomega.GomegaWithT, c client.Client) []*legionv1alpha1.ModelTraining {
