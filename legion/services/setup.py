...
VERSION_FILE = os.path.join(PACKAGE_ROOT_PATH, 'legion/services', 'version.py')
...
setup(
    name='legion-services',
    version=extract_version(),
    description='Legion web services',
    ...
    license='Apache v2',
    entry_points={
        'console_scripts': ['legion-template=legion.services.template.cli:main'],
    },
