...
class TestModelClient(unittest2.TestCase):
    ...
    def test_client_building(self):
        client = ModelClient(self.MODEL_ID, self.MODEL_VERSION, host='localhost')
    ...
    def test_client_building_relative(self):
        client = ModelClient(self.MODEL_ID, self.MODEL_VERSION, use_relative_url=True)
    ...
    def test_client_building_from_env(self):
        with patch('legion.sdk.config.MODEL_SERVER_URL', 'test:10'):
            client = ModelClient(self.MODEL_ID, self.MODEL_VERSION)
