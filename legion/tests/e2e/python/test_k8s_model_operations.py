...
class TestK8SModelOperations(unittest2.TestCase):
    ...
    def test_model_information(self):
        ...
        self.assertEqual(model_service.status, STATUS_OK, 'wrong model status')
    ...
    def test_model_scale_up_and_down(self):
        ...
        wait_until(lambda: model_service.reload_cache() or model_service.scale > 0)
        ...
        wait_until(lambda: model_service.reload_cache() or model_service.scale == model_service.desired_scale)
